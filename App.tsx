...
const Button = ({
  ...
  const base =
    'inline-flex items-center justify-center rounded-sm font-mono font-bold uppercase tracking-widest transition-all duration-300 disabled:opacity-50 disabled:pointer-events-none';

  const variants = {
    neon:
      'bg-cyan-400 text-black hover:bg-white shadow-[0_0_20px_rgba(34,211,238,0.35)] hover:shadow-[0_0_30px_rgba(34,211,238,0.6)]',
    outline:
      'border border-white/15 bg-transparent text-white hover:border-cyan-400 hover:text-cyan-400',
    default:
...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50">
      <div className="absolute inset-0 bg-gradient-to-b from-black via-black/80 to-transparent backdrop-blur-[2px]" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-20 flex items-center justify-between border-b border-white/5 relative z-10">
        <div
          className="flex flex-col items-end group cursor-pointer select-none"
        ...
        >
          ...
          <span className="text-white text-[10px] font-light tracking-[0.2em] -mt-1 mr-0.5 uppercase">
            Films
          </span>
        </div>
        ...
        >
          {isMenuOpen ? (
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="w-4 h-0.5 bg-white self-end" />
            </div>
          )}
        </button>
      </div>
    ...
    <section id="home" className="hero--bg pt-28 pb-16 md:pb-20">
      <div className="hero__content max-w-5xl mx-auto px-4 sm:px-6 text-center flex flex-col items-center">
        ...
        <h1 className="reveal delay-100 text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-black text-white leading-[1.1] tracking-tighter mb-8 uppercase">
          ...
          <span className="text-cyan-400 glow-text underline decoration-cyan-400/30">
        ...
        <p className="reveal delay-200 text-base md:text-xl text-neutral-300 max-w-4xl mx-auto mb-10 font-light leading-relaxed text-balance tracking-tight">
          A Nexxus centraliza o marketing do seu negócio com{' '}
          <span className="text-white font-medium">
            estratégia, conteúdo, design, tráfego pago e execução completa
          </span>{' '}
          em um só lugar. Tudo integrado, com mais clareza, velocidade e resultado.
        </p>
  ...
  return (
    <section id="brands" className="py-20 bg-black border-b border-white/5 overflow-hidden relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <p
          className="text-center text-xl md:text-2xl font-mono text-neutral-400 uppercase tracking-[0.2em] mb-16 reveal"
          style={{
            textShadow:
...
const Portfolio = () => {
  const [selectedVideo, setSelectedVideo] = useState<{ url: string; isVertical?: boolean } | null>(
    null
  );
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="mb-16 reveal">
          <h2 className="text-4xl md:text-5xl font-black text-white mb-4 uppercase">
            PORTFÓLIO <span className="text-cyan-400">ESTRATÉGICO</span>
          </h2>
          <p className="text-neutral-400 font-light max-w-xl">
            Não é apenas estética. É engenharia visual focada em conversão e retenção.
          </p>
        </div>
          ...
          >
            <motion.div
              ...
              className={`relative w-full ${
                selectedVideo.isVertical ? 'max-w-md aspect-[9/16]' : 'max-w-5xl aspect-video'
              } bg-black shadow-2xl overflow-hidden rounded-lg`}
  ...
  const photos = [
    {
      ...
      category: 'REFINO DE DETALHES',
      thumb: 'https://pbs.twimg.com/media/HDPTbaAWQAATwPV?format=jpg&name=medium',
    },
    {
      title: 'COR E CONTRASTE AJUSTADOS',
      category: 'COLOR GRADING',
      thumb: 'https://pbs.twimg.com/media/HE2AoZGXQAAcbAn?format=jpg&name=large',
    },
    {
      title: 'REALCE DE LUZ E TEXTURA',
      category: 'ILUMINAÇÃO CINEMÁTICA',
      thumb: 'https://pbs.twimg.com/media/HE2AoZ1a8AAiypf?format=jpg&name=large',
      fit: 'contain',
    },
  ];
    ...
    <section id="edits" className="py-24 bg-neutral-950 relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="mb-16 reveal text-center md:text-left">
          <h2 className="text-4xl md:text-5xl font-black text-white mb-4 uppercase">
            MELHORIA DE <span className="text-cyan-400">FOTOS</span>
          </h2>
          <p className="text-neutral-400 font-light max-w-xl">
            Transformamos registros comuns em imagens de alto impacto visual e profissionalismo.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {photos.map((photo, i) => (
            <div
              ...
              className={`reveal group relative aspect-[4/3] overflow-hidden border border-white/10 ${
                photo.fit === 'contain' ? 'bg-neutral-950' : 'bg-neutral-900'
              } cursor-pointer`}
            >
              <img
                src={photo.thumb}
                ...
                } opacity-80 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700`}
                loading="lazy"
                referrerPolicy="no-referrer"
              />
              ...
              <div className="absolute bottom-4 left-4">
                <p className="text-[8px] font-mono text-cyan-400 uppercase tracking-widest mb-1">
                  {photo.category}
                </p>
        ...
        <div className="mt-16 flex flex-col items-center reveal">
          <p className="text-neutral-500 text-xs font-mono uppercase tracking-[0.3em] mb-6">
            Acompanhe nosso processo criativo
          </p>
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-purple-600/10 via-pink-600/10 to-orange-500/10 opacity-0 group-hover:opacity-100 transition-opacity" />
            ...
            <div className="text-left">
              <p className="text-[10px] text-neutral-500 font-mono uppercase leading-none mb-1">
                Instagram Oficial
              </p>
...
const LeadFormSection = ({
  ...
  const plans = ['START', 'CONECTA', 'PROFISSIONAL', 'PROJETO PERSONALIZADO'];
...
Vim pelo site.`;
  ...
  return (
    <section
      id="lead-form"
      className="py-24 bg-[#0a0a0a] relative overflow-hidden border-t border-b border-cyan-400/20"
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="reveal">
            ...
            <p className="text-xl text-neutral-400 font-light mb-8 max-w-lg">
              Analisamos seu posicionamento atual e traçamos o plano de vídeos e anúncios
              necessário para sua escala.
            </p>
          ...
          <div className="reveal bg-[#111] p-8 md:p-12 border border-white/5 relative">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-1">
                <label
                  htmlFor="form-name"
                  className="text-[10px] font-mono text-neutral-500 uppercase tracking-widest cursor-pointer"
                >
                  Seu Nome
                </label>
                ...
                <input
                  ...
                  } px-4 py-3 text-white focus:border-cyan-400 outline-none transition-colors`}
                />

                {errors.name && (
                  <p className="text-[10px] text-red-500 font-mono mt-1 uppercase tracking-tighter">
                    {errors.name}
                  </p>
                )}
              </div>
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className={`w-full bg-black border ${
                    errors.niche ? 'border-red-500' : 'border-white/10'
                  } px-4 py-3 text-white focus:border-cyan-400 outline-none transition-colors`}
                />
        ...
        <div className="grid md:grid-cols-[1.2fr_0.8fr] gap-8 md:gap-12 items-center">
          <div className="reveal">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-mono text-neutral-500 uppercase tracking-widest text-[9px] font-bold">
            ...
            <div className="space-y-3 mb-8">
              {(showAll ? symptoms : symptoms.slice(0, 3)).map((item, i) => (
                <div
                  key={i}
                  className="flex gap-3 p-3 border border-white/5 bg-neutral-900/10 hover:border-cyan-500/20 transition-all group"
                >
                  <div className="w-0.5 h-full bg-cyan-400 shrink-0 opacity-50" />

                  <div>
                    <h4 className="text-white font-bold text-xs uppercase group-hover:text-cyan-400 transition-colors">
                      {item.title}
                    </h4>
          ...
          <div className="relative reveal hidden md:block">
            <div className="aspect-[4/3] flex items-center justify-center p-8">
              ...
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2">
                <span className="text-cyan-400 font-mono text-[8px] tracking-[0.3em] uppercase animate-pulse">
                  Status: Scanning...
                </span>
              </div>
            </div>
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
      <div className="text-center max-w-3xl mx-auto mb-20 reveal">
        ...
        <p className="text-xl text-neutral-400 font-light">
          Implementamos o tripé necessário para converter audiência em receita previsível.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-20">
        <div className="reveal group border border-white/10 bg-neutral-900/20 p-8 hover:border-cyan-500/50 transition-all">
          ...
          <p className="text-neutral-400 mb-6 leading-relaxed">
            Vídeos roteirizados para gerar desejo imediato. Foco em Reels, Shorts e TikTok para
            retenção de atenção.
          </p>
        ...
        <div className="reveal group border border-white/10 bg-neutral-900/20 p-8 hover:border-cyan-500/50 transition-all">
          ...
          <p className="text-neutral-400 mb-6 leading-relaxed">
            Não dependa apenas do orgânico. Usamos tráfego pago para colocar seus melhores vídeos na
            frente de quem realmente compra.
          </p>
  ...
  const plans = [
    {
      id: 'start',
      title: 'START',
      desc: 'Ideal para marcas que precisam de presença e consistência mínima estratégica.',
      items: ['Roteirização Técnica', 'Cadência semanal de vídeos', 'Edição Profissional', 'Suporte VIP WhatsApp'],
      price: 'Essencial',
      cta: 'RECEBER PROPOSTA START',
    },
    {
      id: 'conecta',
      title: 'CONECTA',
      desc: 'Foco total em autoridade e engajamento para marcas em expansão rápida.',
      items: [
        'TUDO DO PLANO START',
        'Estratégia Multicanal',
        'Cadência acelerada de vídeos',
        'Calendário de Postagens',
        'Consultoria de Linha Editorial',
      ],
      price: 'Crescimento',
      cta: 'RECEBER PROPOSTA CONECTA',
    },
    {
      id: 'profissional',
      title: 'PROFISSIONAL',
      desc: 'Ecossistema completo: produção + distribuição estratégica de autoridade.',
      items: [
        'TUDO DO PLANO CONECTA',
        'Gestão de Tráfego Pago Inclusa',
        'Criação de Criativos de Conversão',
        'Sessões de Fotos Inclusas',
        'Dashboard de Métricas Mensal',
      ...
      disclaimer: '*Verba de investimento para tráfego pago definida pelo cliente.',
    },
    {
      id: 'personalizado',
      title: 'PROJETO PERSONALIZADO',
      desc: 'Para quem busca negociar algo fora dos padrões. Escopos exclusivos sob demanda total com negociação direta.',
      items: ['Escopo Sob Medida', 'Negociação Direta', 'Equipe Dedicada', 'Flexibilidade Total', 'Consultoria de Escala'],
      price: 'Sob Consulta',
    ...
    <section id="plans" className="py-24 bg-neutral-950 border-t border-b border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-start mb-16 gap-10">
          <div className="reveal">
            <h2 className="text-4xl md:text-5xl font-black text-white mb-4 uppercase leading-tight tracking-tighter">
            ...
            return (
              <div key={plan.id} className="reveal flex flex-col h-full w-full">
                ...
                >
                  {plan.badge && (
                    <div
                      className={`absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 font-bold text-[10px] px-4 py-1.5 uppercase tracking-widest whitespace-nowrap z-20 transition-all duration-500
                      ${
                        isActive
                          ? 'bg-cyan-400 text-black shadow-[0_0_15px_rgba(34,211,238,0.4)] opacity-100'
                          : 'bg-neutral-800 text-neutral-400 opacity-0'
                      }
                    `}
                    >
                      {plan.badge}
                  ...
                  <div className="relative z-20 mb-6 flex-shrink-0">
                    <h3
                      className={`text-2xl font-black mb-1 uppercase transition-colors duration-500 ${
                    ...
                    <p
                      className={`text-neutral-500 text-[10px] font-mono uppercase tracking-widest transition-opacity duration-500 ${
                  ...
                  <div className={`flex flex-col flex-grow transition-all duration-700 ${isOthersSelected ? 'opacity-60 grayscale-[0.3]' : 'opacity-100'}`}>
                    <p className="text-neutral-400 text-sm mb-6 leading-relaxed flex-shrink-0 min-h-[5.5rem]">
                      {plan.desc}
                    </p>

                    <div className={`h-[1px] w-12 mb-8 transition-colors duration-500 flex-shrink-0 ${isActive ? 'bg-cyan-400' : 'bg-white/20'}`} />
                    ...
                    <div className="space-y-4 pt-6 mt-auto border-t border-white/5">
                      ...
                      {plan.disclaimer && (
                        <p className="text-[9px] text-neutral-600 uppercase font-mono leading-tight">
                          {plan.disclaimer}
                        </p>
                      )}
                    </div>
...
const FAQ = () => {
  ...
  const faqs = [
    {
      q: 'O investimento em anúncios está incluso no plano?',
      a: 'No plano PROFISSIONAL, a GESTÃO e ESTRATÉGIA dos anúncios está inclusa. A verba de mídia paga, ou seja, o dinheiro que vai para o Meta/Google, é definida por você e paga diretamente às plataformas.',
    },
    {
      q: 'Preciso aparecer nos vídeos?',
      a: 'Não necessariamente. Criamos estratégias de conteúdo faceless ou institucionais. No entanto, vídeos com o rosto do especialista tendem a gerar mais conexão e autoridade.',
    },
    {
      q: 'Em quanto tempo recebo os primeiros vídeos?',
      a: 'Após a assinatura do contrato e briefing, nosso protocolo de planejamento estratégico leva 10 dias úteis. A primeira entrega final costuma ocorrer em até 15 dias após a captação.',
    },
    {
      q: 'Tem contrato mínimo?',
      a: 'Trabalhamos com ciclos semestrais para garantir que o algoritmo e o tráfego pago tenham tempo de maturação e tragam o ROI esperado.',
    },
    {
      q: 'Vocês fazem a roteirização?',
      a: 'Sim. Todo o nosso sistema baseia-se em roteiros técnicos focados em conversão, para que você ou sua equipe apenas executem com perfeição sob nossa direção.',
    },
  ];
  ...
  return (
    <section id="faq" className="py-24 bg-neutral-950 relative overflow-hidden">
      <div
        className="absolute -bottom-32 -left-32 w-[500px] h-[500px] opacity-40 pointer-events-none mix-blend-screen"
        style={{
      ...
      >
        <img
          src="https://pbs.twimg.com/media/HDUHHbeaMAEIKld?format=jpg&name=4096x4096"
          alt=""
      ...
      <div
        className="absolute -bottom-32 -right-32 w-[500px] h-[500px] opacity-30 pointer-events-none mix-blend-screen"
        style={{
          maskImage: 'radial-gradient(circle, black 0%, transparent 70%)',
          WebkitMaskImage: 'radial-gradient(circle, black 0%, transparent 70%)',
        }}
      >
        <img
          src="https://pbs.twimg.com/media/HDUG0mCW4AEMUek?format=jpg&name=4096x4096"
          alt=""
          className="w-full h-full object-cover"
          referrerPolicy="no-referrer"
        />
      ...
      <div
        className="absolute -bottom-40 left-1/2 -translate-x-1/2 w-[600px] h-[600px] opacity-25 pointer-events-none mix-blend-screen"
        style={{
          maskImage: 'radial-gradient(circle, black 0%, transparent 70%)',
          WebkitMaskImage: 'radial-gradient(circle, black 0%, transparent 70%)',
        }}
      >
        <img
          src="https://pbs.twimg.com/media/HDUFl2bWwAAZJ_q?format=jpg&name=4096x4096"
          alt=""
          className="w-full h-full object-cover"
          referrerPolicy="no-referrer"
        />
        ...
        <div className="space-y-4">
          {faqs.map((faq, i) => (
            <div key={i} className="border border-white/10 bg-black">
              ...
              >
                <span className="font-bold text-neutral-200 uppercase text-sm tracking-tight">
                  {faq.q}
                </span>
      ...
      <div className="grid md:grid-cols-2 gap-16 mb-20 items-center">
        <div className="reveal">
          <h2 className="text-4xl md:text-5xl font-black text-white mb-8 uppercase leading-tight">
            DOMINE o SEU <br />
            <span className="text-cyan-400 underline">MERCADO AGORA.</span>
          </h2>
          ...
          <div className="space-y-6">
            ...
            >
              <div className="w-12 h-12 border border-white/10 flex items-center justify-center group-hover:border-cyan-400">
                <Phone className="w-5 h-5" />
              </div>

              <div>
                <p className="text-[10px] text-neutral-500 uppercase font-mono">WhatsApp Comercial</p>
                <span className="text-lg font-mono">(11) 99594-5323</span>
              </div>
            </button>

            <a
              href="https://instagram.com/nexxusfilms"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-4 text-white hover:text-cyan-400 transition-colors group"
            >
              <div className="w-12 h-12 border border-white/10 flex items-center justify-center group-hover:border-cyan-400">
              ...
              <div>
                <p className="text-[10px] text-neutral-500 uppercase font-mono">Instagram Oficial</p>
                <span className="text-lg font-mono">@nexxusfilms</span>
              </div>
            </a>

            <a
              href="mailto:nexxusfilms@gmail.com"
              className="flex items-center gap-4 text-white hover:text-cyan-400 transition-colors group"
            >
              <div className="w-12 h-12 border border-white/10 flex items-center justify-center group-hover:border-cyan-400">
              ...
              <div>
                <p className="text-[10px] text-neutral-500 uppercase font-mono">E-mail de Negócios</p>
                <span className="text-lg font-mono">nexxusfilms@gmail.com</span>
              </div>
            </a>
          </div>
        </div>
        ...
        <div className="reveal bg-neutral-900/30 p-10 border border-white/10 text-center relative overflow-hidden">
          ...
          <div className="mt-6 text-[9px] md:text-[10px] font-mono uppercase tracking-widest leading-relaxed">
            <span className="text-cyan-400/60 font-bold">// ATENDIMENTO REMOTO: TODO O BRASIL</span>
            <br />
            <span className="text-neutral-600">// ATENDIMENTO PRESENCIAL: SÃO PAULO - SP</span>
          </div>
        </div>
      </div>
